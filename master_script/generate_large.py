...
if __name__ == "__main__":
    ...
    for i in range(-4, 5):  # Controls vertical stacking
        row_heightmaps = []  # Will store horizontally stacked heightmaps
        
        for j in range(-4, 5):  # Controls horizontal stacking
            heightmap = main(70, effective_zero_x + j, effective_zero_y + i, debug=True)
