...
/**
 * This function creates a texture array from the given vector of texture paths. It loads each texture and stores it in the texture array.
 * The textures must all be the same size and format.
 */
// GLuint createTexture2DArray(const std::vector<std::string>& texturePaths) {
//     if (texturePaths.empty()) {
//         throw std::runtime_error("No textures provided for texture array.");
//     }
