...
int main(int argc, char** argv){
    ...
    try
    {
        ...
        Settings settings = Settings(
            ...
            make_shared<Parameters>(Parameters(true)), // The parameters for the terrain generation (Initially default parameters with 1k textures)
            // Fog settings
            ...
            true // Whether to use 1k textures or not, where true = 1k textures and false = 2k textures
        );
