...
void World::updateData(bool regenerate){
    ...
    if (regenerate){
        ...
        std::vector<std::string> diffuseTexturePaths = {
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getBorealTextureLow(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getBorealTextureMidFlat(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getBorealTextureMidSteep(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getBorealTextureHigh(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getGrassyTextureLow(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getGrassyTextureMidFlat(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getGrassyTextureMidSteep(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getGrassyTextureHigh(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getGrassyStoneTextureLow(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getGrassyStoneTextureMidFlat(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getGrassyStoneTextureMidSteep(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getGrassyStoneTextureHigh(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getSnowyTextureLow(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getSnowyTextureMidFlat(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getSnowyTextureMidSteep(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getSnowyTextureHigh(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getIcyTextureLow(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getIcyTextureMidFlat(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getIcyTextureMidSteep(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getIcyTextureHigh(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getSavannaTextureLow(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getSavannaTextureMidFlat(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getSavannaTextureMidSteep(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getSavannaTextureHigh(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getWoodlandTextureLow(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getWoodlandTextureMidFlat(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getWoodlandTextureMidSteep(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getWoodlandTextureHigh(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getJungleTextureLow(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getJungleTextureMidFlat(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getJungleTextureMidSteep(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getJungleTextureHigh(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getJungleMountainsTextureLow(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getJungleMountainsTextureMidFlat(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getJungleMountainsTextureMidSteep(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getJungleMountainsTextureHigh(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getVolcanicTextureLow(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getVolcanicTextureMidFlat(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getVolcanicTextureMidSteep(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getVolcanicTextureHigh(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getTemperateTextureLow(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getTemperateTextureMidFlat(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getTemperateTextureMidSteep(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getTemperateTextureHigh(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getSwampTextureLow(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getSwampTextureMidFlat(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getSwampTextureMidSteep(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getSwampTextureHigh(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getSeasonalForestTextureLow(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getSeasonalForestTextureMidFlat(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getSeasonalForestTextureMidSteep(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getSeasonalForestTextureHigh(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getAutumnTextureLow(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getAutumnTextureMidFlat(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getAutumnTextureMidSteep(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getAutumnTextureHigh(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getMesaTextureLow(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getMesaTextureMidFlat(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getMesaTextureMidSteep(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getMesaTextureHigh(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getHotDesertTextureLow(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getHotDesertTextureMidFlat(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getHotDesertTextureMidSteep(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getHotDesertTextureHigh(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getDustyTextureLow(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getDustyTextureMidFlat(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getDustyTextureMidSteep(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getDustyTextureHigh(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getBadlandsTextureLow(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getBadlandsTextureMidFlat(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getBadlandsTextureMidSteep(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getBadlandsTextureHigh(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getOasisTextureLow(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getOasisTextureMidFlat(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getOasisTextureMidSteep(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getOasisTextureHigh(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getOceanTextureLow(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getOceanTextureMidFlat(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getOceanTextureMidSteep(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getOceanTextureHigh(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getCliffsTextureLow(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getCliffsTextureMidFlat(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getCliffsTextureMidSteep(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"}),
            settings->getParameters()->findTextureFilePath(settings->getParameters()->getCliffsTextureHigh(), settings->getFilePathDelimitter(), {"_diff", "_Color","_color","_albedo"})
        };
