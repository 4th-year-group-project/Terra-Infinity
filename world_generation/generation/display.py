...
class Display:
    ...
    def _get_colormap(self):
        ...
        colormaps = {
            ...
            "volcanic": self._create_colormap([
                (0.8, 0.3, 0.1),
                (0.7, 0.2, 0.1),
                (0.5, 0.15, 0.1),
                (0.3, 0.2, 0.2),
            ...
            "badlands": self._create_colormap([
                (0.95, 0.8, 0.5),
                (0.85, 0.6, 0.3),
                (0.75, 0.5, 0.2),
                (0.6, 0.3, 0.1),
            ...
            "hot_desert": self._create_colormap([
                (1.0, 0.9, 0.7),
                (0.95, 0.8, 0.6),
                (0.9, 0.7, 0.5),
                (0.8, 0.6, 0.4),
            ...
            "rocky_muddy": self._create_colormap([
                (0.2, 0.15, 0.1),
                (0.3, 0.2, 0.15),
                (0.4, 0.3, 0.2),
                (0.5, 0.4, 0.3),
            ...
            "lush_plains": self._create_colormap([
                (0.0, 0.1, 0.4),
                (0.6, 0.8, 0.9),
                (0.4, 0.7, 0.4),
                (0.4, 0.7, 0.4),
