...
from world_generation.master_script.master_script import main
...
if __name__ == "__main__":
    params = {
        ...
        "grassland": {
            "plains": {"max_height": 30, "occurrence_probability": 50, "evenness": 50, "tree_density": 50},
            "hills": {"max_height": 40, "occurrence_probability": 50, "bumpiness": 50, "tree_density": 50},
            "rocky_fields": {"max_height": 40, "occurrence_probability": 50, "rockiness": 0.6, "tree_density": 50},
            "terraced_fields": {
                "max_height": 40,
        ...
        "woodland": {"hills": {"max_height": 40, "occurrence_probability": 50, "bumpiness": 50, "tree_density": 50}},
        "tropical_rainforest": {
            "plains": {"max_height": 40, "occurrence_probability": 50, "evenness": 50, "tree_density": 50},
        ...
        "temperate_rainforest": {
            "hills": {"max_height": 40, "occurrence_probability": 0, "bumpiness": 50, "tree_density": 50},
            "mountains": {"max_height": 80, "occurrence_probability": 0, "ruggedness": 100, "tree_density": 50},
            "swamp": {"max_height": 10, "occurrence_probability": 50, "wetness": 50, "tree_density": 50},
        },
        ...
        "ocean": {
            "flat_seabed": {"max_height": 90, "evenness": 0, "occurrence_probability": 50},
            "volcanic_islands": {
                "max_height": 20,
                "occurrence_probability": 0,
                "size": 0.4,
            ...
            "water_stacks": {"max_height": 20, "occurrence_probability": 0, "size": 0.4},
            "trenches": {"density": 0.5, "occurrence_probability": 0, "trench_width": 0.4, "smoothness": 0.3},
        },
    }
